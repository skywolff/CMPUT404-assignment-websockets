...
function getColor(){
    var colour = "#000000";
    while(colour === "#000000")
        // taken from https://stackoverflow.com/questions/1484508/random-color-generator by Mohsen
...
function wsSetup() {
    ...
    socket.onerror = function(event) {
        debug("WebSocket Error:" + event.data);
        console.error("websocket error: ", event);
    };
    socket.onmessage = function(msg) {  
        try {
            var newWorld = JSON.parse(msg.data);
            // console.log(newWorld);
            world = newWorld;
        } catch (e) {
            console.log("scoket.onmessage error: " + e);
        }
    }; 
}
